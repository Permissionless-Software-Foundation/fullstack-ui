...
class Example extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <div className="endpoint-example-cointainer">
                    <p>{_this.state.detailedDescription}</p>
                    <div className="enpoint-parameters">
                        <div>
                            <b>Parameters:</b>
                            <p>{_this.state.parameters ? _this.state.parameterType : 'No Parameters'}</p>
                        </div>
                        <div>
                            <b>Description :</b>
                    ...
                    {_this.state.requestResult ?
                        <>
                            <div className="endpoint-example-response">
                                <h4>Response Body:</h4>
                                <JSONPretty id="json-pretty" data={_this.state.requestResult}></JSONPretty>
                            </div>

                            <button className="example-clear-button" onClick={_this.clearRequestResult}>Clear</button>
    ...
    startRequest() {
        ...
        if (_this.state.endpointType === 'get' || _this.state.endpointType === 'GET') {
            _this.requestGET()
        } else if (_this.state.endpointType === 'post' || _this.state.endpointType === 'POST') {
            _this.requestPOST()
        }
    }
